...
|:------|:------|---------:|--------:|:---------|---------:|
| q0 | passthrough (ingest+egest boundary) | 541.1 | 719 | 3/2/2 | 9,200 |
| q1 | + 1 projection delegate (price map) | 595.5 | 835 | 4/4/2 | 9,200 |
| q2 | + filter (auction % 123 = 0) | 403.0 | 581 | 3/3/1 | 74 |
| q22 | + 3 string SPLIT_INDEX projections | 771.4 | 948 | 4/4/2 | 9,200 |
| q3 | join (auction ⋈ person, filtered) | 76.0 | 89 | 0/0/0 | 22 |
| q20 | join (bid ⋈ auction, wide output) | 1104.6 | 1291 | 3/2/1 | 1,890 |
| q4 | join + nested MAX + outer AVG | 2159.1 | 2376 | 5/3/1 | 10 |
| q9 | join + partitioned TOP-1 | 1335.2 | 2349 | 6/3/1 | 1,430 |
| q18 | partitioned TOP-1 dedup | 1839.6 | 2224 | 2/1/0 | 9,200 |
| q19 | partitioned TOP-10 | 1862.0 | 1734 | 4/2/1 | 8,706 |
